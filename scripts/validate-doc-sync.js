...
const mustContain = [
  {
    ...
    values: [
      ...
      "gh workflow run triage-reminder.yml",
      "gh workflow run triage-auto-clear.yml",
      ".github/workflows/triage-auto-clear.yml",
      ".github/workflows/triage-reminder.yml",
      ".github/dependabot.yml",
    ],
  ...
  },
  {
    ...
    values: [
      ...
      "LABEL_AUDIT_FAIL_ON_DRIFT_INPUT",
      "LABEL_AUDIT_FAIL_ON_DRIFT_REPO",
  ...
  },
  {
    ...
    values: [
      ...
      "Skipped non-open issues:",
      "Skipped without needs-triage label:",
      "Reminders posted:",
    ],
  },
  {
